...
data = dict(
    ...
    train=dict(
        ...
        target=dict(
            type='ACDCDataset',
            data_root='/share/home/dq070/CoT/datasets/fz+dz',
            img_dir='fz+nightimd',  #sd_rfs_twilight
            ann_dir='gt/train',
    ...
    # val=dict(
    #     type='ACDCDataset',
    #     data_root='/share/home/dq070/lfh/fog_medium/fog',
    #         img_dir='img/val',
    #         ann_dir='gt/val/labelTrainIds',
    #     pipeline=test_pipeline),
    # val=dict(
    #     type='ACDCDataset',
    #     data_root='/share/home/dq070/hy-tmp/AS_id_all/NighttimeDriving',
    #         img_dir='img/val-rename',
    #         ann_dir='gt/labelTrainIds-rename',
    #     pipeline=test_pipeline),
    val=dict(
        type='ACDCDataset',
        data_root='/share/home/dq070/hy-tmp/AS_id_all/fog-driving',
            img_dir='img2',
            ann_dir='gt2',
        pipeline=test_pipeline),
    test=dict(
