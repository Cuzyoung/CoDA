...
_base_ = [
    ...
    '../_base_/datasets/uda_cityscapesHR_to_foggydriving_1024x1024.py',
    # DAFormer Self-Training
    '../_base_/uda/dacs_fdthings.py',
    # AdamW Optimizer
...
# Random Seed
seed = 38  # seed with median performance
# HRDA Configuration
model = dict(
...
checkpoint_config = dict(by_epoch=False, interval=4000, max_keep_ckpts=5)
